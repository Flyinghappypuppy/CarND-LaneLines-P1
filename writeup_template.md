...
3. Apply Canny edge detection algorithm on the image
	<img title="After first 3 steps" ="After first 3 steps" src="https://github.com/timeperceptron/Lane-Detection-CarND-P1/blob/master/demo_gifs/pipeline/a.gif" width="600" >
